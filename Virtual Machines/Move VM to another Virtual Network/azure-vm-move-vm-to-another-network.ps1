...
Write-Host "Selecting subscription ID" $OriginSubscriptionId -ForegroundColor Cyan
Set-AzContext -Subscription -SubscriptionId $OriginSubscriptionId -ErrorAction Stop
...
Set-AzContext -Subscription -SubscriptionId $TargetSubscriptionId -ErrorAction Stop
